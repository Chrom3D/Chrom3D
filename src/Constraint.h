...
enum ConstraintType {REGULAR=0, INTERACTION=1, LAMIN=2, NUCLEUS=3, BOUNDARY=4, CENTER=5, C_T_COUNT=6, INTERACTION_INTRA=7, INTERACTION_INTER=8, INTERACTION_DIST=9, NON_INTERACTION_DIST=10};
